            ...
            <div className="border-b flex-grow  text-left bg-white  shadow-md rounded-lg p-3 md:p-5 2xl:ml-6 2xl:max-w-[40rem] ">
              ...
              <p className="text-lg mb-8 max-w-2xl ml-4 text-gray-700 font-semibold italic">
                <>
                  ...
                  loves building fast, reliable, and user-friendly applications.
                  I work on both front-end and back-end, making sure everything
                  runs smoothly. I enjoy solving complex problems and turning
                  ideas into real, working solutions with clean and maintainable
                  code. My goal is to keep learning, improving, and creating
